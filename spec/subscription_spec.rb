...
describe WealthForge::Subscription do

  context 'subscription2' do
    ...
    before do
      ...
      WealthForge.configure do |config|
        ...
        config.environment = 'qa1'
      end

      VCR.configure do |c|
        c.ignore_hosts '127.0.0.1', 'localhost', 'api.wealthforge.org'
    ...
    it 'get all subscriptions pls' do



      response = WealthForge::Subscription.all
      p response
